      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '2rem', position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ 
          ...
          <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
            <h2 style={{ fontSize: '2rem', fontWeight: 800, color: 'var(--color-navy)', letterSpacing: '-0.02em', marginBottom: '0.5rem' }}>Create Account</h2>
            <p style={{ color: 'var(--color-text-muted)', fontSize: '1rem' }}>Enter your details to become a verified agent.</p>
          </div>
          ...
          {success ? (
            <div style={{ padding: '2.5rem 1.5rem', backgroundColor: 'var(--color-primary-light)', border: '1px solid var(--color-primary)', borderRadius: '16px', textAlign: 'center' }}>
              ...
              <h3 style={{ fontSize: '1.5rem', fontWeight: 700, color: 'var(--color-navy)', marginBottom: '0.5rem' }}>Application Submitted</h3>
              <p style={{ color: 'var(--color-text-muted)', lineHeight: 1.6 }}>Your premium account has been created. Redirecting to the secure login portal...</p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                ...
                <input 
                  name="agencyName" type="text" required value={formData.agencyName} onChange={handleInputChange}
                  placeholder="e.g. Elite Homes Kenya" 
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                <label style={{ fontWeight: 600, fontSize: '0.875rem', color: 'var(--color-text-main)' }}>Phone Number</label>
                <input 
                  name="phoneNumber" type="tel" required value={formData.phoneNumber} onChange={handleInputChange}
              ...
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '0.75rem', marginTop: '0.5rem' }}>
                ...
                <label htmlFor="terms" style={{ fontSize: '0.875rem', color: 'var(--color-text-muted)', lineHeight: '1.5' }}>
                  I agree to the <Link href="/terms" target="_blank" style={{ color: 'var(--color-primary)', textDecoration: 'none' }}>Terms & Conditions</Link> and <Link href="/privacy" target="_blank" style={{ color: 'var(--color-primary)', textDecoration: 'none' }}>Privacy Policy</Link>. I understand my property ownership details will be kept confidential and only shared with verified clients.
                </label>
              </div>
              ...
              <button type="submit" disabled={isLoading} style={{ 
                ...
                {isLoading ? "Processing Application..." : "Create Premium Account"}
              </button>
            </form>
          )}

          <div style={{ marginTop: '2.5rem', textAlign: 'center', fontSize: '0.875rem', color: '#64748B' }}>
            Already have an account? <Link href="/login" style={{ color: '#10B981', fontWeight: 600, textDecoration: 'none' }}>Sign in to Portal</Link>
          </div>
        </div>
      </div>
